        ...
        <div className='container'>
            <div className='card bg-light'>
                <article className='card-body mx-auto' style={{ width: "500px" }}>
                    ...
                    <p>
                        <button className='btn btn-block btn-twitter btn-like-link'>
                            <i className='fa fa-twitter'></i> Login via Twitter
                        </button>
                        <button className='btn btn-block btn-facebook btn-like-link'>
                            <i className='fa fa-facebook'></i> Login via Facebook
                        </button>
                        <button className='btn btn-block btn-google btn-like-link'>
